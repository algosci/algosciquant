...
parser = argparse.ArgumentParser("get ticker,f stock data, historical prices from Google Finance and save to CSV file")
...
dfstock=getGoogleSpData(args.startDate,args.endDate,v=0)
